...
public class PlayerAiming : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Input
        float xMovement = Input.GetAxisRaw(PlayerConstants.MouseX) * sensitivityMultiplier * 10;
        float yMovement = -Input.GetAxisRaw(PlayerConstants.MouseY) * sensitivityMultiplier * 10;
